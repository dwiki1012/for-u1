document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        ...
        { time: 2, text: "But when we go outside" },
        { time: 3, text: "You're gonna wake up and see that it was hopeless after all" },
        { time: 10, text: "What if we rewrite the stars ?" },
        { time: 14, text: "Say you were made to be mine"},
        { time: 16, text: "Nothin' could keep us apart" },
        { time: 20, text: "You'll be the one I was meant to find" },
        { time: 24, text: "It's up to you, and it's up to me" },
        { time: 28, text: "No one could say what we get to be" },
        { time: 31, text: "So why don't we rewrite the stars?" },
        { time: 35, text: "And maybe the world could be ours, tonight" },
        { time: 38, text: "tonight ?" },
    ];
